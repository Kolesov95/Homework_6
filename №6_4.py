...
print(car_1.name, car_1.color, car_1.name, car_1.is_police)
print(car_2.name, car_2.color, car_2.name, car_2.is_police)
print(car_3.name, car_3.color, car_3.name, car_3.is_police)
print(car_4.name, car_4.color, car_4.name, car_4.is_police)
car_1.go()
car_2.go()
car_1.showspeed()
car_4.turn('на лево')
